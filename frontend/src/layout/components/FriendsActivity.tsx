					...
					<div key={user._id} className="cursor-pointer hover:bg-zinc-800/50 p-3 rounded-md transition-colors group ">
						<div className="flex items-start gap-3 ">
							<div className="relative "> 
								...
								<div className="absolute bottom-0 right-0 size-3 rounded-full border-2 border-zinc-900 bg-zinc-500" /> {/* watch out */}
                              ...
                              <div className="flex-1 min-w-0 ">
								...
								{isPlaying ? (
									<div className="mt-1">
										...
										<div className="text-xs text-zinc-400 truncate">By Tailor swift</div>
									...
									<div className="text-xs text-zinc-400 truncate">Idle</div>
								)}
